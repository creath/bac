...
// Copyright (c) 2011-2012 BitAlphaCoin Developers
...
void ThreadIRCSeed()
{
    ...
    RenameThread("BitAlphaCoin-ircseed");
...
void ThreadIRCSeed2()
{
    ...
    while (true)
    {
        ...
        if (fTestNet) {
            Send(hSocket, "JOIN #NewBitAlphaCoinTEST0\r");
            Send(hSocket, "WHO #NewBitAlphaCoinTEST0\r");
        } else {
            // randomly join #NewBitAlphaCoin00-#NewBitAlphaCoin99
            // network is now over 3k peers , get them to join 50 random channels!
            //            channel_number = 0; 
            int channel_number = 0; //GetRandInt(50);

            Send(hSocket, strprintf("JOIN #NewBitAlphaCoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #NewBitAlphaCoin%02d\r", channel_number).c_str());
        }
