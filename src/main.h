...
static const int64 DUST_SOFT_LIMIT = 1000000;
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 10000;
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 7900000000 * COIN; // BitAlphaCoin: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 5) / 250; // BitAlphaCoin: Priority cutoff is 2 BitAlphaCoin day / 250 bytes.
    }
